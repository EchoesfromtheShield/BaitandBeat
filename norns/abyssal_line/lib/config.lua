...
Config.STRUGGLE_TENSION_STEP = 0.006
Config.STRUGGLE_PULL_TENSION = 0.44
Config.STRUGGLE_PULL_SLEW = 0.07
Config.STRUGGLE_ENCODER_RESISTANCE = 4.2
...
Config.CAPTURE_RATE = 0.11
Config.CAPTURE_DECAY_RATE = 0.045
