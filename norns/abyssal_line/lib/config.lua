...
Config.STRUGGLE_TENSION_STEP = 0.010
Config.STRUGGLE_PULL_TENSION = 0.28
Config.STRUGGLE_PULL_SLEW = 0.08
...
Config.SAFE_TENSION_MIN = 0.38
Config.SAFE_TENSION_MAX = 0.60
